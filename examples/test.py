...
def print_status():
    ...
    print(f'context_engine.kv_cache_mem_handles:{context_engine.kv_cache_mem_handles}')
    ...
    print(f'decoding_engine.kv_cache_mem_handles:{decoding_engine.kv_cache_mem_handles}')
